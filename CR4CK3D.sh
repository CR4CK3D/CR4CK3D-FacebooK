...
echo $i" |"$cy"     INI BUKAN SCRIPT CURIAN!
 "$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" MR.CR4CK3D  [D4RKCYB3RT34M]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" MR.CR4CK3D"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MR.M3M3K] [MR.ST4N3D] [MR.B4C0D]"$i"  |"
echo $i" |"$cy"            ~ [cyber] [%MR.C%] [MR.CR4CK3D]"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" +37121599164"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" sisilc268@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
echo $i"|"$me" 1"$i" |"$cy" CR4CK3D FB PHP        "$i"|"$i"    |"$cy" B"$i" |"
echo $i"|"$me" 2"$i" |"$cy" CR4CK3D FB BR1G4D3    "$i"|"$i"    |"$cy" E"$i" |"
echo $i"|"$me" 3"$i" |"$cy" CR4CK3D FB iqbalz     "$i"|"$i"    |"$cy" N"$i" |"
echo $i"|"$me" 4"$i" |"$cy" CR4CK3D FB MBF        "$i"|"$i"    |"$cy" G"$i" |"
echo $i"|"$me" 5"$i" |"$cy" FACECR4CK3D N1ght420       "$i"|"$i"    |"$cy" K"$i" |"
echo $i"|"$me" 6"$i" |"$cy" CR4CK3D FB ( root )   "$i"|"$i"    |"$cy" E"$i" |"
echo $i"────────────────────────────────"$i"    |"$cy" L"$i" |"
...
echo $i"────────────────────────────────"$i"    |"$cy" R"$i" |"
echo $i"|"$me"18"$i" |"$cy" INSTALL BAHAN DULU PEPEK  "$i"|"$i"    |"$cy" E"$i" |"
echo $i"|"$me"19"$i" |"$cy" KELUAR/EXIT PROGRAM      "$i"|"$i"    |"$cy" N"$i" |"
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"D4RKCYB3RT34M"$bi"]"$me"======"$bi"["$i""Pilih Nomornya!""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $ku"WhatsApp :"$i" +37121599164"
echo $ku"Facebook :"$i" -"
sleep 2
